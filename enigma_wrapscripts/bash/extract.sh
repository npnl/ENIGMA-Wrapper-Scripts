...
for subj_id in $(ls -d subjects/subj*); do #may need to change this so that it selects subjects with FS output

#mkdir ${subj_id}/outputs
#mkdir ${subj_id}/outputs/stats
